 ...
 * Start a backup job
 */
class StartBackup implements TaskInterface, ContainerAwareInterface
{
	...
	public function execute(array $parameters = array())
	{
		...
		{
			$model       = $container->mvcFactory->makeTempModel('Backup');
			$description = $model->getDefaultDescription() . ' (JSON API)';
		}
