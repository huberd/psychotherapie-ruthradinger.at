...
class Schedule extends Model
{
	public function getPaths()
	{
		...
		$ret->info->root_url     = rtrim(
			Platform::getInstance()->get_platform_configuration_option('siteurl', ''), '/'
		);
	...
	public function getCheckPaths()
	{
		...
		{
			$ret->frontend->path = defined('WPINC')
				? admin_url('admin-ajax.php?action=akeebabackup_check')
				: 'index.php?view=check';
	...
	private function getPhpPath(): ?string
	{
		...
		$cParams     = $this->container->appConfig;
