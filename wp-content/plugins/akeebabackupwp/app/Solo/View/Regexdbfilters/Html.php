...
class Html extends View
{
	...
	public function onBeforeMain()
	{
		...
		$document->addScriptOptions('akeeba.RegExDatabaseFilters.guiData', [
		...
		$doc->lang('COM_AKEEBA_FILEFILTERS_UIROOT');
		$doc->lang('COM_AKEEBA_FILEFILTERS_LABEL_UIERRORFILTER');
		$doc->lang('COM_AKEEBA_DBFILTER_TYPE_REGEXTABLES');
		$doc->lang('COM_AKEEBA_DBFILTER_TYPE_REGEXTABLEDATA');
