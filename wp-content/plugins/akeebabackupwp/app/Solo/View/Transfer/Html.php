...
class Html extends View
{
	...
	public function onBeforeWizard($tpl = null)
	{
		...
		{
			$lastBackupDate = $this->container->dateFactory($this->latestBackup['backupstart'], 'UTC');
		...
		*/
		...
		$document->addScriptOptions(
			...
			[
				'randomName' => $randomPrefix . '.php',
			]
		);
		$document->addScriptOptions(
			'akeeba.System.params.AjaxURL',
			$router->route(sprintf("index.php?view=Transfer&format=raw&force=%d", $this->force))
		);
