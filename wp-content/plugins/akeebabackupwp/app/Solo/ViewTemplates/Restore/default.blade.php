...
<form action="@route('index.php?view=restore&task=start&id=' . $this->id)" method="POST"
    ...
    @if($this->getContainer()->appConfig->get('showDeleteOnRestore', 0) == 1)
        <div class="akeeba-form-group">
            ...
            <div class="akeeba-toggle">
                @html('fefselect.booleanList', 'zapbefore', array('forToggle' => 1, 'colorBoolean' => 1), 0)
            </div>
            <p class="akeeba-help-text">
    ...
    <div class="akeeba-form-group">
        ...
        <div class="akeeba-toggle">
            @html('fefselect.booleanList', 'stealthmode', array('forToggle' => 1, 'colorBoolean' => 1), 0)
        </div>
        <p class="akeeba-help-text">
    ...
    <div id="ftpOptions">
        ...
        <div class="akeeba-form-group">
            ...
            <input id="ftp_initial_directory" name="ftp_root" value="{{{ $this->ftpparams['ftp_root'] }}}"
                   type="text" />
        </div>
    </div>
