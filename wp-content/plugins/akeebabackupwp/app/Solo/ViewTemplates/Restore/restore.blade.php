...
<div id="restoration-extract-ok" style="display:none">
    <div class="akeeba-block--success">
        ...
        @if (empty($this->siteURL))
            <p>
                @lang('SOLO_RESTORE_LABEL_SUCCESS_INFO')
            </p>
        @else
            <p>
                @sprintf('SOLO_RESTORE_LABEL_SUCCESS_INFO_HASURL', $this->siteURL, $this->siteURL)
            </p>
        @endif
    </div>
    ...
    @if (!empty($this->siteURL))
        <p>
            <button class="akeeba-btn--primary" id="restoration-runinstaller">
                ...
                @lang('SOLO_RESTORE_BTN_INSTALLER')
            </button>
        </p>
        <p>
    ...
    @else
        <button class="akeeba-btn--green" id="restoration-finalize">
            <span class="akion-android-exit"></span>
            @lang('COM_AKEEBA_RESTORE_LABEL_FINALIZE')
        </button>
    @endif
