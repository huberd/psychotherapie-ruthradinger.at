...
<div class="akeeba-panel--information">
    ...
    @else
        ...
        <p>
            ...
            <code>
                wget --max-redirect=10000 "{{ $this->checkinfo->info->root_url.'/'.$this->checkinfo->frontend->path }}"
        ...
        <p>
            ...
            <code>
                ...
                "{{ $this->checkinfo->info->root_url.'/'.$this->checkinfo->frontend->path }}" 1>/dev/null 2>/dev/null
            </code>
        </p>
