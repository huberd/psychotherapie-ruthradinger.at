...
$videoCode = $this->getContainer()->segment->get('insideCMS', false)
    ...
    <form class="akeeba-form--horizontal">
        <div class="akeeba-transfer-main-container">
            ...
            <div id="akeeba-transfer-row-url" class="akeeba-form-group--pull-right">
                <img src="@media('media://image/loading.gif', false, $this->getContainer()->application)"
        ...
        <div id="akeeba-transfer-ftp-container" style="display: none">
            <div class="akeeba-form-group">
                ...
                {{ $this->getContainer()->html->select->genericList($this->transferOptions, 'akeeba-transfer-ftp-method', [], 'value', 'text', $this->transferOption, 'akeeba-transfer-ftp-method') }}
            ...
            <div class="akeeba-form-group">
                ...
                <input type="text" value="{{{ $this->ftpPubKey }}}" id="akeeba-transfer-ftp-pubkey"
                       placeholder="{{{ APATH_SITE . DIRECTORY_SEPARATOR }}}id_rsa.pub" />
            </div>
            ...
            <div class="akeeba-form-group">
                ...
                <input type="text" value="{{{ $this->ftpPrivateKey }}}" id="akeeba-transfer-ftp-privatekey"
                       placeholder="{{{ APATH_SITE . DIRECTORY_SEPARATOR }}}id_rsa" />
            </div>
            ...
            <div class="akeeba-form-group">
                ...
                @html('select.genericlist', $this->chunkOptions, 'akeeba-transfer-chunkmode', array(), 'value', 'text', $this->chunkMode, 'akeeba-transfer-chunkmode')
            ...
            <div class="akeeba-form-group">
                ...
                @html('select.genericlist', $this->chunkSizeOptions, 'akeeba-transfer-chunksize', array(), 'value', 'text', $this->chunkSize, 'akeeba-transfer-chunksize')
                <p class="akeeba-help-text">
            ...
            <div class="akeeba-form-group" id="akeeba-transfer-ftp-passive-container">
                ...
                <div class="akeeba-toggle">
                    @html('fefselect.booleanList', 'akeeba-transfer-ftp-passive', array('forToggle' => 1, 'colorBoolean' => 1), $this->ftpPassive ? 1 : 0, 'AWF_YES', 'AWF_NO', 'akeeba-transfer-ftp-passive')
                </div>
            </div>
            ...
            <div class="akeeba-form-group" id="akeeba-transfer-ftp-passive-fix-container">
                ...
                <div class="akeeba-toggle">
                    @html('fefselect.booleanList', 'akeeba-transfer-ftp-passive-fix', array('forToggle' => 1, 'colorBoolean' => 1), $this->ftpPassive ? 1 : 0, 'AWF_YES', 'AWF_NO', 'akeeba-transfer-ftp-passive-fix')
                </div>
                <p class="akeeba-help-text">
            ...
            <div class="akeeba-block--failure" id="akeeba-transfer-ftp-error" style="display:none;">
                ...
                <a href="@route('index.php?view=transfer&force=1')"
