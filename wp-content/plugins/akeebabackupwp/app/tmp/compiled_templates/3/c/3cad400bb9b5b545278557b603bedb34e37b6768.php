<?php /* F:\wamp64\www\psychotherapie-ruthradinger.at\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Fsfilters\default.blade.php */ ?>
<?php
/**
 * @package   solo
...
<form class="akeeba-form--inline akeeba-panel--info">
    <div class="akeeba-form-group">
		<label><?php echo $this->getLanguage()->text('COM_AKEEBA_FILEFILTERS_LABEL_ROOTDIR'); ?></label>
    ...
    <div class="akeeba-form-group--actions">
        <button class="akeeba-btn--red" id="comAkeebaFileFiltersNuke">
			...
			<?php echo $this->getLanguage()->text('COM_AKEEBA_FILEFILTERS_LABEL_NUKEFILTERS'); ?>
        </button>
    </div>
</form>
...
<div class="akeeba-container--50-50">
    <div>
        <div class="akeeba-panel--info">
            <header class="akeeba-block-header">
                <h3>
					<?php echo $this->getLanguage()->text('COM_AKEEBA_FILEFILTERS_LABEL_DIRS'); ?>
                </h3>
            </header>
            <div id="folders"></div>
        </div>
    ...
    <div>
        <div class="akeeba-panel--info">
            <header class="akeeba-block-header">
                <h3>
					<?php echo $this->getLanguage()->text('COM_AKEEBA_FILEFILTERS_LABEL_FILES'); ?>
                </h3>
            </header>
            <div id="files"></div>
        </div>
