<?php /* F:\wamp64\www\annapraxmarer.at\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Sysconfig\update.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div id="sysconfigUpdate" class="tab-pane">
    ...
    <?php if ( ! ($inCMS)): ?>
        <div class="akeeba-form-group">
            ...
            <p class="akeeba-help-text">
                <?php echo $this->getLanguage()->text('SOLO_CONFIG_UPDATE_NO_PHP_VERSION_CHECK_DESC'); ?>
            </p>
        </div>
    <?php else: ?>
        <div class="akeeba-form-group">
            ...
            <div class="akeeba-toggle">
                ...
                <strong><?php echo $this->getLanguage()->text('AWF_YES'); ?></strong>
            </div>
            <p class="akeeba-help-text">
