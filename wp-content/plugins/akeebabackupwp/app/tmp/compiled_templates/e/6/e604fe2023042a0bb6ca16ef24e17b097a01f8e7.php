<?php /* C:\wamp64\www\lammer-installationen.at\wp-content\plugins\akeebabackupwp\app\Solo\ViewTemplates\Configuration\default.blade.php */ ?>
<?php
/**
 * @package   solo
...
<div class="akeeba-block--info">
	<?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_WHERE_ARE_THE_FILTERS'); ?>
</div>
...
<form name="adminForm" id="adminForm" method="post"
    ...
    <div class="akeeba-panel--info" style="margin-bottom: -1em">
        <header class="akeeba-block-header">
            <h5>
	            <?php echo $this->getLanguage()->text('COM_AKEEBA_PROFILES_LABEL_DESCRIPTION'); ?>
            </h5>
        </header>

		<div class="akeeba-form-group">
			<label for="profilename" rel="popover"
				   data-original-title="<?php echo $this->getLanguage()->text('COM_AKEEBA_PROFILES_LABEL_DESCRIPTION'); ?>"
				   data-content="<?php echo $this->getLanguage()->text('COM_AKEEBA_PROFILES_LABEL_DESCRIPTION_TOOLTIP'); ?>">
				<?php echo $this->getLanguage()->text('COM_AKEEBA_PROFILES_LABEL_DESCRIPTION'); ?>
			</label>
		...
		<div class="akeeba-form-group">
			<label for="quickicon" rel="popover"
				   data-original-title="<?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_QUICKICON_LABEL'); ?>"
				   data-content="<?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_QUICKICON_DESC'); ?>">
				<?php echo $this->getLanguage()->text('COM_AKEEBA_CONFIG_QUICKICON_LABEL'); ?>
			</label>
            <div>
