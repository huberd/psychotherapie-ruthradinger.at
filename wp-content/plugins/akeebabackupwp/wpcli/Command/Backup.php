...
class Backup
{
	...
	public function _list($args, $assoc_args)
	{
		...
		/** @var Manage $model */
		$model = $akeebaBackupWordPressContainer->mvcFactory->makeTempModel('Manage');
	...
	public function upload($args, $assoc_args)
	{
		...
		/** @var Upload $model */
		$model = $akeebaBackupWordPressContainer->mvcFactory->makeTempModel('Upload');
		$part = 0;
		$frag = 0;
	...
	public function fetch($args, $assoc_args)
	{
		...
		$model = $akeebaBackupWordPressContainer->mvcFactory->makeTempModel('Remotefiles');
		$part = 0;
		$frag = 0;
