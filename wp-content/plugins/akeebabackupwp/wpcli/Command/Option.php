...
class Option
{
	 ...
	 * ## EXAMPLES
	 *
	 *     wp akeeba option set akeeba.basic.archive_name "site-[HOST]-[DATE]-[TIME]-[RANDOM]"
	 *
	 *     wp akeeba option set akeeba.basic.archive_name "site-[HOST]-[DATE]-[TIME]-[RANDOM]" --profile=2
	 *
	 * @when       after_wp_load
	 *
	 * @param   array $args       Positional arguments (literal arguments)
	...
	public function set($args, $assoc_args)
	{
		...
		switch ($optionInfo['type'])
		{
			...
			default:
				WP_CLI::error("Unknown type {$optionInfo['type']} for option '$key'. Have you manually tampered with the option JSON files?");
				break;
		}
