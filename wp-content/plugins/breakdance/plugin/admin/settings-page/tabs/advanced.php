            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Allowing SVG uploads can be dangerous, and you should understand the <a href='<?php echo $docs_link_security; ?>' target='_blank'>potential security implications</a>. If in doubt, use a plugin like <a href='https://wordpress.org/plugins/safe-svg/' target="_blank">Safe SVG</a> instead of this option.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        Apply <code>the_content</code> filter to <?php echo $bdoroxy; ?> content
                    </th>
                    <td>
                        <fieldset>
                        ...
                        <p class="description">By default, <?php echo $bdoroxy; ?> does not apply <code>the_content</code> filter to <?php echo $bdoroxy; ?>-designed content. You can enable this option to make <?php echo $bdoroxy; ?> run <code>apply_filters('the_content', ...)</code> on singular content created with <?php echo $bdoroxy; ?>, but you should understand the <a href='<?php echo $docs_link_security; ?>'>potential security implications</a>.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        Allow unfiltered HTML in all dynamic data output
                    </th>
                    <td>
                        <fieldset>
                            <label for="allow_unfiltered_html">
                                <input type="checkbox" <?php echo $allow_unfiltered_html ? 'checked' : ''; ?> name="allow_unfiltered_html" value="yes" id="allow_unfiltered_html"> Allow
                            </label>
                        </fieldset>

                        <p class="description">By default, <?php echo $bdoroxy; ?> applies <code>wp_kses_post</code> to fields on posts with an author that lacks the <code>unfiltered_html</code> capability. You can disable this if you understand the <a href='<?php echo $docs_link_security; ?>'>potential security implications</a>.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">For each page, on save, if the quantity of stored revisions of <?php echo $bdoroxy; ?> content is higher than the <code>Max Revisions</code> setting, the oldest revisions will be removed your database.</p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                    ...
                    <td>
                        ...
                        <p class="description">If <code>Limit Revisions</code> is enabled, this is the max number of revisions of <?php echo $bdoroxy; ?> content that will be kept for each page.</p>
                    </td>
                </tr>
            </tbody>
        </table>
