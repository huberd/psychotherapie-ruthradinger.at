                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($show_activate_license_btn) : ?>
                            <input type="submit" class="button-secondary" name="activate_license" value="Activate License">
                        <?php endif; ?>

                        <?php if ($show_deactivate_license_btn) : ?>
                            <input type="submit" class="button-secondary" name="deactivate_license" value="Deactivate License">
                        <?php endif; ?>
                        ...
                        <p class="description">
                            ...
                            if (BREAKDANCE_MODE === 'oxygen') {
                                ?>
                                    Visit <a href='https://oxygenbuilder.com/' target="_blank">oxygenbuilder.com</a> to purchase a license key. Already purchased? Find your license key in the <a href='https://oxygenbuilder.com/portal' target="_blank">customer portal</a>.
                                <?php
                            }
