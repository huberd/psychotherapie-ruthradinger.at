...
?>
    ...
    <form action="" method="post">
        ...
        <p>Set builder access and user interface mode by user role. Set on a per-user basis from the Edit User screen.</p>

        <div class="notice notice-warning inline padded-notice">
            <p>Do not grant <strong>Edit Content Interface Only</strong> access to untrusted users. This access simplifies the user interface, but does not <a href='<?php echo $docs_link_security; ?>' target='_blank'>restrict privileges</a>.</p>
        </div>
