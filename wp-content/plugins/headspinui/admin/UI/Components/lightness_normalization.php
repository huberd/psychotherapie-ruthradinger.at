 ...
 */
function lightness_normalization($mode)
{
?>
    <div class="luminance-normalization-group">

        <template x-for="(item,i) in $store.pd.lightness_normalization.<?php echo esc_attr($mode); ?>">
                ...
                <div class="luminance-slider-container">
                    ...
                    <div class="slider-controls" :style="`--_lumVal: ${item.value * 100}%; --_lumMin: ${item.min * 100}%; --_lumMax: ${item.max * 100}%; `">
                        ...
                        <input
                            ...
                            max="1"
                            :step="0.001"
                            @change="$store.project.regenratePaletteOutput()"
                            x-model="item.value">
                    </div>
